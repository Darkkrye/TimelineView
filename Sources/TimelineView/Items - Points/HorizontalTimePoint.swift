...
public class HorizontalTimePoint: TimelinePoint {
    public init(diameter: CGFloat = 15, strokeWidth: CGFloat = 2, strokeColor: UIColor = .clear, fillColor: UIColor = .clear, lineWidth: CGFloat = 2, lineColor: UIColor = .clear, topLabel: UILabel? = nil, bottomLabel: UILabel? = nil) {
